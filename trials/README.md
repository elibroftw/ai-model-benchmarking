...
| 3 | `openai/gpt-6-astra` | V | yes | 3/3 | 87.6s | $1.76 | $24.13 | 3/3 | 123,840 | 10,481 |
| 4 | `openai/gpt-5.6-terra-pro` | V | -- | 3/3 | 97.1 | $1.73 | $21.36 | 3/3 | 464,384 | 66,577 |
| 5 | `anthropic/claude-opus-5` | V | -- | 3/3 | 99.7 | $1.48 | $17.83 | 3/3 | 154,825 | 28,293 |
| 6 | `anthropic/claude-fable-5` | V | yes | 3/3 | 105.3s | $2.93 | $33.34 | 3/3 | 145,111 | 29,483 |
| 7 | `anthropic/claude-fable-5.1` | V | yes | 3/3 | 108.1s | $3.16 | $35.06 | 3/3 | 192,510 | 24,656 |
| 8 | `deepseek/deepseek-v4.1-flash` | T | yes | 3/3 | 112.8s | $0.09 | $0.92 | 3/3 | 164,518 | 103,686 |
| 9 | `google/gemini-3.8-flash` | V | yes | 3/3 | 129.4s | $0.47 | $4.34 | 3/3 | 344,179 | 56,051 |
| 10 | `openai/gpt-5.6-sol-pro` | V | -- | 3/3 | 141.4 | $1.78 | $15.08 | 3/3 | 288,251 | 62,336 |
| 11 | `meta/muse-spark-1.2` | V | -- | 3/3 | 142.4s | $0.62 | $5.22 | 3/3 | 158,599 | 99,192 |
| 12 | `z-ai/glm-5.3-flash` | V | -- | 3/3 | 173.3s | $0.07 | $0.50 | 3/3 | 224,641 | 75,772 |
| 13 | `anthropic/claude-sonnet-5` | V | -- | 3/3 | 212.3 | $1.59 | $9.00 | 3/3 | 417,092 | 75,732 |
| 14 | `deepseek/deepseek-v4-pro-0813` | T | yes | 3/3 | 273.3s | $0.25 | $1.09 | 3/3 | 183,190 | 64,437 |
| 15 | `meta/muse-spark-1.3` | V | -- | 3/3 | 297.6s | $1.33 | $5.38 | 3/3 | 332,985 | 215,995 |
| 16 | `z-ai/glm-5.3` | T | -- | 3/3 | 404.7 | $1.86 | $5.51 | 3/3 | 957,568 | 117,955 |
| 17 | `x-ai/grok-4.6` | V | -- | 3/3 | 418.2 | $0.76 | $2.19 | 3/3 | 102,119 | 93,413 |
| 18 | `moonshotai/kimi-k3` | V | -- | 3/3 | 499.2 | $3.89 | $9.35 | 3/3 | 900,394 | 119,054 |
| 19 | `qwen/qwen3.8-max` | V | -- | 3/3 | 499.6 | $1.00 | $2.39 | 3/3 | 258,427 | 79,789 |
| 20 | `~deepseek/deepseek-v4-flash-latest` | T | -- | 3/3 | 527.4 | $0.13 | $0.30 | 3/3 | 1,396,193 | 218,938 |
| 21 | `qwen/qwen3.8-27b` | V | -- | 3/3* | 527.9s | $0.35 | $0.79 | 3/3 | 138,624 | 97,426 |
| 22 | `z-ai/glm-5.2` | T | -- | 3/3 | 583.3 | $1.23 | $2.52 | 3/3 | 3,172,546 | 152,419 |

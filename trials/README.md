...
| 8 | `google/gemini-3.8-flash` | V | yes | 3/3 | 129.4s | $0.47 | $4.34 | 3/3 | 344,179 | 56,051 |
| 9 | `openai/gpt-5.6-sol-pro` | V | -- | 3/3 | 141.4 | $1.78 | $15.08 | 3/3 | 288,251 | 62,336 |
| 10 | `meta/muse-spark-1.2` | V | -- | 3/3 | 142.4s | $0.62 | $5.22 | 3/3 | 158,599 | 99,192 |
| 11 | `z-ai/glm-5.3-flash` | V | -- | 3/3 | 173.3s | $0.07 | $0.50 | 3/3 | 224,641 | 75,772 |
| 12 | `anthropic/claude-sonnet-5` | V | -- | 3/3 | 212.3 | $1.59 | $9.00 | 3/3 | 417,092 | 75,732 |
| 13 | `deepseek/deepseek-v4-pro-0813` | T | yes | 3/3 | 273.3s | $0.25 | $1.09 | 3/3 | 183,190 | 64,437 |
| 14 | `meta/muse-spark-1.3` | V | yes | 3/3 | 301.8s | $1.33 | $5.31 | 3/3 | 332,985 | 215,995 |
| 15 | `z-ai/glm-5.3` | T | -- | 3/3 | 404.7 | $1.86 | $5.51 | 3/3 | 957,568 | 117,955 |
| 16 | `x-ai/grok-4.6` | V | -- | 3/3 | 418.2 | $0.76 | $2.19 | 3/3 | 102,119 | 93,413 |
| 17 | `moonshotai/kimi-k3` | V | -- | 3/3 | 499.2 | $3.89 | $9.35 | 3/3 | 900,394 | 119,054 |
| 18 | `qwen/qwen3.8-max` | V | -- | 3/3 | 499.6 | $1.00 | $2.39 | 3/3 | 258,427 | 79,789 |
